...
const ByeNow = () => {
  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="my-10 max-w-2xl mx-auto bg-[#EFE2D5] p-6 rounded-lg shadow-md border border-gray-300">
        <h2 className="text-2xl font-bold mb-4 text-center text-[#C49102]">Buy Your Furniture</h2>
