    ...
    <MaxWidthWrapper>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-5 relative">
        <Carousel>
                ...
                <div className=" rounded-md border border-gray-100">
                  <div className="px-4 pt-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      /> :     <FaUserCircle size={50} color="#FFB200"/>}
                      ...
                      {review.customerType}
                                     ...
                                     <p className="text-[#FFB200] flex gap-1 mt-1">
                    ...
                    <div className="flex items-center relative">
                      <p className="h-[2px] w-[70%] bg-[#FFB200]  mt-3"></p>
                      <p className="text-[#FFB200] absolute right-[26%] top-1 ">
                  ...
                  {/* Star rating */}
                  <div className="mt-3 bg-[#FFB200]/10 p-4">
          ...
          <CarouselPrevious className="hover:bg-[#FFB200] hover:text-white border-gray-200"/>
          <CarouselNext  className="hover:bg-[#FFB200] hover:text-white border-gray-200"/>
        </Carousel>
          {modalImage && (
                <div
